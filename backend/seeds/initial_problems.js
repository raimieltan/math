exports.seed = function (knex) {
  return knex.raw(`
    ...
    (
      ...
      'A',
      '{ "A": "$14,25", "B": "$14.75", "C": "$20.75", "D": "$15.25" }'
    ),
    ...
    (
      ...
      'D',
      '{ "A": "About 7", "B": "About 10", "C": "About 12", "D": "About 17" }'
    ),
    ...
    (
      ...
      After 4 Days: 8,000',
      'B',
      '{ "A": "7,000", "B": "8,000", "C": "9,000", "D": "11,600" }'
    ),
    ...
    (
      ...
      'A',
      '{ "A": "9,000", "B": "10,800", "C": "13,000", "D": "10,980" }'
    ),
